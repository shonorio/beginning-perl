...
\noindent Perl não é uma língua difícil de aprender. É uma linguagem que tenta moldar-se a maneira como os homens pensam sobre os problemas e fornece nada contrário às suas expectativas. Perls' designers acreditar que Perl é uma linguagem populista - e não apenas para os matemáticos e cientistas de computador deste mundo.
